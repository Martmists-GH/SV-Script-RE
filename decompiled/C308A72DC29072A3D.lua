...
function C308A72DC29072A3D_prototype:F34D7200F169A6CAC(A1_2)
  ...
  L4_2 = {}
  L4_2.dispHp = true
  L4_2.animeEndHp = true
  L4_2.animeFrame = true
  L4_2.isPlayedPinchSE = true
  L4_2.pokeID = true
  L4_2.isDispGauge = true
  L3_2.__fields__ = L4_2
  L3_2.dispHp = 0
  L3_2.animeEndHp = 0
  L3_2.animeFrame = 0
  L3_2.isPlayedPinchSE = false
  L3_2.pokeID = 0
    ...
    if L5_2 ~= A2_2 then
      ...
      if L5_2 then
        ...
        if L7_2 then
          ...
          L9_2 = 13
          L7_2 = L7_2(L8_2, L9_2)
          L4_2.animeEndHp = L7_2
          L7_2 = L58_1
          L8_2 = L4_2.animeEndHp
          L7_2 = L7_2(L8_2)
          L4_2.dispHp = L7_2
        end
      end
...
function C308A72DC29072A3D_prototype:FAEE3DC0237BD78F9()
  ...
  while true do
    ...
    L10_2 = L4_2.isAnime
    L9_2.isAnime = L10_2
    L10_2 = L4_2.animeStartHp
    L9_2.animeStartHp = L10_2
    L10_2 = L4_2.animeEndHp
    L9_2.animeEndHp = L10_2
    L10_2 = L4_2.animeCnt
    L9_2.animeCnt = L10_2
    L10_2 = L4_2.isGaugeRed
    L9_2.isGaugeRed = L10_2
