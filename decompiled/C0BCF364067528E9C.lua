...
L68_1[L69_1] = L70_1
L68_1 = "C0BCF364067528E9C"
L69_1 = _ENV["C0BCF364067528E9C"]
L25_1[L68_1] = L69_1
...
function C0BCF364067528E9C.S94693C87339ED135(A0_2)
  ...
  if -1 ~= L1_2 then
    L2_2 = C0BCF364067528E9C
    L2_2 = L2_2.S94D56946FBF01B27
    L3_2 = C0BCF364067528E9C
    L3_2 = L3_2.S7210FB87613FB518
    L3_2 = L3_2[L1_2]
    L3_2 = L3_2.findFlg
    L4_2 = 8
...
function C0BCF364067528E9C.SE71F0259656A6605(A0_2)
  ...
  while L2_2 < L3_2 do
    ...
    L5_2 = L5_2.S94D56946FBF01B27
    L6_2 = C0BCF364067528E9C
    L6_2 = L6_2.S7210FB87613FB518
    L6_2 = L6_2[L4_2]
    L6_2 = L6_2.findFlg
    L7_2 = 8
    L5_2 = L5_2(L6_2, L7_2)
...
function C0BCF364067528E9C.S80881CEF6C7F896D()
  ...
  while L0_2 < L1_2 do
    ...
    L2_2 = L2_2[L3_2]
    L3_2 = L2_2.findFlg
    if 1 == L3_2 or 4 == L3_2 then
      L4_2 = C0BCF364067528E9C
      L4_2 = L4_2.SEA9A50E66E4EE53D
      L5_2 = L2_2
      L6_2 = 0
      L4_2(L5_2, L6_2)
      L4_2 = L2_2.positionXFlagName
...
function C0BCF364067528E9C.S3FC31718F27B1A63(A0_2, A1_2)
  ...
  if -1 ~= L2_2 then
    ...
    L3_2 = L3_2.S7210FB87613FB518
    L3_2 = L3_2[L2_2]
    L4_2 = L3_2.positionXFlagName
    if "" ~= L4_2 then
      L4_2 = L3_2.positionYFlagName
      if "" ~= L4_2 then
        L4_2 = L3_2.positionZFlagName
        if "" ~= L4_2 then
          goto lbl_20
        end
      end
    ...
    L9_2 = L5_2
    L7_2(L8_2, L9_2)
    L7_2 = L3_2.positionYFlagName
    L8_2 = L10_1.math
    L8_2 = L8_2.floor
    L9_2 = A1_2[2]
    L10_2 = C0BCF364067528E9C
    L10_2 = L10_2.S54275C29A8E76855
    L9_2 = L9_2 * L10_2
    L8_2 = L8_2(L9_2)
    ...
    L10_2 = c37452BA0
    L10_2 = L10_2.f8A7498B1
    L11_2 = L7_2
    L12_2 = L8_2
    L10_2(L11_2, L12_2)
    L10_2 = L3_2.positionZFlagName
    L11_2 = L10_1.math
    L11_2 = L11_2.floor
    L12_2 = A1_2[3]
    L13_2 = C0BCF364067528E9C
    L13_2 = L13_2.S54275C29A8E76855
    L12_2 = L12_2 * L13_2
    L11_2 = L11_2(L12_2)
...
function C0BCF364067528E9C.SABADD54FDE8E80E7(A0_2)
  ...
  if -1 ~= L1_2 then
    ...
    L2_2 = L2_2.S7210FB87613FB518
    L2_2 = L2_2[L1_2]
    L3_2 = L2_2.positionXFlagName
    if "" ~= L3_2 then
      L3_2 = L2_2.positionYFlagName
      if "" ~= L3_2 then
        L3_2 = L2_2.positionZFlagName
        if "" ~= L3_2 then
          goto lbl_21
        end
      end
    ...
    L8_2 = L7_2
    if 0 == L4_2 or 0 == L6_2 or 0 == L8_2 then
      L9_2 = nil
      return L9_2
    end
    L9_2 = {}
    ...
    L10_2 = L10_2.S54275C29A8E76855
    L10_2 = L4_2 / L10_2
    L11_2 = C0BCF364067528E9C
    L11_2 = L11_2.S54275C29A8E76855
    L11_2 = L6_2 / L11_2
    L12_2 = C0BCF364067528E9C
    L12_2 = L12_2.S54275C29A8E76855
    L12_2 = L8_2 / L12_2
    L9_2[1] = L10_2
    L9_2[2] = L11_2
    L9_2[3] = L12_2
...
function C0BCF364067528E9C.S94D56946FBF01B27(A0_2, A1_2)
  ...
  elseif 6 == A1_2 then
    if 4 == A0_2 or 5 == A0_2 then
      L2_2 = true
    end
  elseif 7 == A1_2 then
    if 1 == A0_2 or 4 == A0_2 then
      L2_2 = true
    end
  elseif 8 == A1_2 then
    if 2 == A0_2 or 5 == A0_2 then
      L2_2 = true
    end
  elseif 9 == A1_2 and 0 ~= A0_2 then
    L2_2 = true
  end
  return L2_2
end
...
function C0BCF364067528E9C.S62C6CBD7A44375EB(A0_2)
  ...
  if L1_2 then
    ...
    L1_2 = L1_2()
    L2_2 = C0BCF364067528E9C
    L2_2 = L2_2.S99C63972692AAC2A
    if L1_2 > L2_2 then
      L1_2 = C0BCF364067528E9C
      L1_2 = L1_2.S5483E9038B79E486
      return L1_2
    else
      L1_2 = C0BCF364067528E9C
      L1_2 = L1_2.S0140B53A374ED0C6
      return L1_2
    end
  end
  L1_2 = C0BCF364067528E9C
...
function C0BCF364067528E9C_prototype:FC0345553D75921A3()
  ...
  if L3_2 then
    ...
    while L4_2 < L5_2 do
      ...
      L11_2 = L6_2
      L10_2 = L6_2.f3D9D438D
      L12_2 = "battleFlagName"
      ...
      L13_2 = L6_2
      L12_2 = L6_2.f3D9D438D
      L14_2 = "battleMessageName"
      L12_2 = L12_2(L13_2, L14_2)
      L14_2 = L6_2
      L13_2 = L6_2.f3D9D438D
      L15_2 = "ranchMessageName"
      ...
      L16_2 = L6_2
      L15_2 = L6_2.f3D9D438D
      L17_2 = "positionXFlagName"
      L15_2 = L15_2(L16_2, L17_2)
      L17_2 = L6_2
      L16_2 = L6_2.f3D9D438D
      L18_2 = "positionYFlagName"
      L16_2 = L16_2(L17_2, L18_2)
      L18_2 = L6_2
      L17_2 = L6_2.f3D9D438D
      L19_2 = "positionZFlagName"
      ...
      L19_2 = C0BCF364067528E9C
      L19_2 = L19_2.S7210FB87613FB518
      L20_2 = L19_2
      L19_2 = L19_2.push
      L21_2 = L16_1
      L22_2 = {}
      L23_2 = {}
      L23_2.name = true
      L23_2.findFlgName = true
      L23_2.findFlg = true
      L23_2.isBattle = true
      L23_2.battleFlgName = true
      L23_2.battleId = true
      L23_2.battleMessage = true
      L23_2.ranchMessage = true
      L23_2.feature = true
      L23_2.positionXFlagName = true
      L23_2.positionYFlagName = true
      L23_2.positionZFlagName = true
      L22_2.__fields__ = L23_2
      L22_2.name = L7_2
      L22_2.findFlgName = L8_2
      L22_2.findFlg = L18_2
      L22_2.isBattle = L9_2
      L22_2.battleFlgName = L10_2
      L22_2.battleId = L11_2
      L22_2.battleMessage = L12_2
      L22_2.ranchMessage = L13_2
      L22_2.feature = L14_2
      L22_2.positionXFlagName = L15_2
      L22_2.positionYFlagName = L16_2
      L22_2.positionZFlagName = L17_2
...
L68_1 = _ENV["C0BCF364067528E9C"]
L69_1 = "__super__"
L69_1 = _ENV["C0BCF364067528E9C"]["prototype"]
L70_1 = {}
L71_1 = "__index"
