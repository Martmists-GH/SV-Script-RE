...
function L70_1(A0_2)
  ...
  if nil ~= L1_2 then
    ...
    A0_2[10] = false
    A0_2[11] = "once_action_trigger"
    A0_2[12] = "once_action_type_int"
    A0_2[13] = 2
  end
end
