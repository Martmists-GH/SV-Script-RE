---@alias C84402048F601B87E main_field_contents_poke_talk_PokeTalkEntity

---@class main_field_contents_poke_talk_PokeTalkEntity : C84402048F601B87E_prototype
---@field prototype C84402048F601B87E_prototype
L55_1 = _ENV
...
---@class C84402048F601B87E_prototype
C84402048F601B87E_prototype = L15_1()
C84402048F601B87E.prototype = C84402048F601B87E_prototype
--- main.field.contents.poke_talk.PokeTalkEntity.GetTag
function C84402048F601B87E_prototype:F86AB611C2307B41D()
  local L1_2
  L1_2 = "PokeTalkEntity"
  return L1_2
end

--- main.field.contents.poke_talk.PokeTalkEntity.OnPreUpdate
function C84402048F601B87E_prototype:FDCB19E22FE1BB508(A1_2)
  ...
  elseif 1 == L2_2 then
    ...
    if L3_2 then
      ...
      if 0 == L3_2 or 1 == L3_2 or 3 == L3_2 then
        L5_2 = self
        L4_2 = self.F8A5063FE818FC7C7
        L6_2 = A1_2
        L4_2(L5_2, L6_2)
      elseif 2 == L3_2 then
        L5_2 = self
        L4_2 = self.F5FB56D6F1386DD91
        L6_2 = A1_2
        L4_2(L5_2, L6_2)
      end
      self[1] = true
...
--- main.field.contents.poke_talk.PokeTalkEntity.SelectEndPicnicMode
function C84402048F601B87E_prototype:F8A5063FE818FC7C7(A1_2)
  ...
  if 1 == L2_2 or 2 == L2_2 then
    ...
    L5_2 = self
    L4_2 = self.F1A202DC10654458C
    L4_2(L5_2)
  end
end

--- main.field.contents.poke_talk.PokeTalkEntity.SelectEndWildMode
function C84402048F601B87E_prototype:F5FB56D6F1386DD91(A1_2)
  local L2_2, L3_2
  L3_2 = self
  L2_2 = self.F1A202DC10654458C
  L2_2(L3_2)
end

--- main.field.contents.poke_talk.PokeTalkEntity.CommonTalkEndProcess
function C84402048F601B87E_prototype:F1A202DC10654458C()
...
--- main.field.contents.poke_talk.PokeTalkEntity.WildTalkModeCoroutine
function C84402048F601B87E_prototype:FD4B87DB3D0989652()
  local L1_2, L2_2, L3_2, L4_2, L5_2, L6_2, L7_2, L8_2, L9_2, L10_2, L11_2
  L1_2 = c4E28AB7C
  L1_2 = L1_2.fB41FD22F
  L2_2 = self[2]
...
--- main.field.contents.poke_talk.PokeTalkEntity.EventFollowPokeTalkModeCoroutine
function C84402048F601B87E_prototype:F321AE534F540825C()
