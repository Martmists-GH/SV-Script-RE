...
function CFF2F988D895214C3.new(A0_2)
  local L1_2
  L1_2 = L2_1(CFF2F988D895214C3.prototype, 33, 68)
...
function CFF2F988D895214C3.super(self, A1_2)
  self[KEY_pageIndex] = 0
  self[32] = c03C8030E.f101D811F()
  self[KEY_pages] = L26_1.new()
  self[30] = nil
...
function CFF2F988D895214C3.prototype.FE94F3E13286232CF(self, A1_2)  -- PreUpdate
  local L3_2
  if not self[KEY_isSetup] then
    return
  end
  if self[30] ~= nil then
    self[30]:F3CDE8608003DBD80()  -- self[30]:GridPanelUpdate()
    if c69ACCC6F.f8C317F18(self[5], nil) then
      L3_2 = self[30]:FE0EF7358F88CA776():f33A1A337()  -- self[30]:get_gridPanel():f33A1A337()
      if not L3_2 then
...
function CFF2F988D895214C3.prototype.F706FCB31D5565CDB(self)  -- StartFlow
...
function CFF2F988D895214C3.prototype.FF1C9BF636E0F4F06(self)  -- IsSetup
  return self[KEY_isSetup]
end

function CFF2F988D895214C3.prototype.F2A87963AC5F3088C(self)  -- SetupGridPanel
...
function CFF2F988D895214C3.prototype.FFEF40EBB4F2389C2(self)  -- UnLoadScene
  self[1]:f462C9B70():f5C99C0AC()
end

function CFF2F988D895214C3.prototype.FD04D323C034FC5C6(self)  -- DebugPokemonListSetup
  ...
  if L1_2 > 0 then
    ...
    self[KEY_pages]:push(L6_2)
  end
end

function CFF2F988D895214C3.prototype.F119ADEB65DAA355B(self)  -- PrevPage
  self[KEY_pageIndex] = self[KEY_pageIndex] - 1
  if self[KEY_pageIndex] < 0 then
    self[KEY_pageIndex] = self[KEY_pages].length - 1
  end
  self:FD5BF2CE0251913A7()  -- self:PokeListCopyMember()
  self:FA197DA508C3432B5()  -- self:UpdatePokeListPanel()
end

function CFF2F988D895214C3.prototype.FCC895445CF9D2653(self)  -- NextPage
  self[KEY_pageIndex] = self[KEY_pageIndex] - 1
  if self[KEY_pageIndex] > self[KEY_pages].length then
    self[KEY_pageIndex] = 0
  end
  self:FD5BF2CE0251913A7()  -- self:PokeListCopyMember()
  self:FA197DA508C3432B5()  -- self:UpdatePokeListPanel()
...
function CFF2F988D895214C3.prototype.FA197DA508C3432B5(self)  -- UpdatePokeListPanel
...
function CFF2F988D895214C3.prototype.FD5BF2CE0251913A7(self)  -- PokeListCopyMember
  local L1_2, L6_2, L8_2
  L1_2 = c03C8030E.f101D811F()
  for L2_2 = 0, self[14] - 1 do
    L6_2 = cC99399C3.f101D811F()  -- InitialSpec.create()
    if self[KEY_pages][self[KEY_pageIndex]][L2_2] ~= 0 then
      L6_2:f2247607A(self[KEY_pages][self[KEY_pageIndex]][L2_2])  -- setMonsNo
...
function CFF2F988D895214C3.prototype.FEC2224ACB6BB724A(self)  -- TemochiBackup
  self[32]:fEFB3ECFD(c1A1CBE3B.fFCE06E04())
end

function CFF2F988D895214C3.prototype.FDCEBC1565BCB169E(self)  -- TemochiRestore
  c1A1CBE3B.fFCE06E04():fEFB3ECFD(self[32])
end

CFF2F988D895214C3.prototype.__class__ = CFF2F988D895214C3
CFF2F988D895214C3.__super__ = C3C7D6227912AFE27
setmetatable(CFF2F988D895214C3.prototype, {__index = C3C7D6227912AFE27})
