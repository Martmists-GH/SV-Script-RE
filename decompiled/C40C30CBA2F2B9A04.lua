...
function C40C30CBA2F2B9A04_prototype:FD8D5F3745B4B5174()
  ...
  L16_2 = L16_2.S61AB39B97FD53F6D
  L17_2 = CC6FE82819C6E1D55
  L17_2 = L17_2.SFBF86D7C138AB6C6
  L18_2 = "map_change_core"
  L19_2 = nil
  L20_2 = L16_1
  L21_2 = {}
  L22_2 = {}
  L22_2.mapChangeInfo = true
  L22_2.fadeType = true
  ...
  L24_2 = {}
  L24_2.type = true
  L24_2.destScene = true
  L24_2.destLocation = true
  L24_2.destOffset = true
  L23_2.__fields__ = L24_2
  L23_2.type = 3
  L24_2 = L1_2.destScene
  L23_2.destScene = L24_2
  L24_2 = L1_2.destLocation
  L23_2.destLocation = L24_2
  L24_2 = L1_2.destOffset
  L23_2.destOffset = L24_2
  L22_2 = L22_2(L23_2)
  L21_2.mapChangeInfo = L22_2
  L21_2.fadeType = 0
...
function C40C30CBA2F2B9A04_prototype:F9FC926CA4C3A67D5(A1_2)
  ...
  L3_2 = A1_2.startObjectName
  L2_2 = L2_2(L3_2)
  if nil == L2_2 then
    return
  end
  L3_2 = CDCBFD50A277E546D
  L3_2 = L3_2.S06AD3DD8F7385046
  L4_2 = A1_2.startObjectName
  L5_2 = A1_2.startStateName
  L3_2 = L3_2(L4_2, L5_2)
  L4_2 = A1_2.startOpenState
  if L3_2 == L4_2 then
    return
  end
  L3_2 = CDCBFD50A277E546D
  ...
  L4_2 = A1_2.startObjectName
  L5_2 = A1_2.startOpenState
  L6_2 = A1_2.startStateName
  L3_2(L4_2, L5_2, L6_2)
  L3_2 = A1_2.openSeWaitTime
  if L3_2 > 0 then
    L3_2 = CC6FE82819C6E1D55
    L3_2 = L3_2.S32FAD7D4DF3ACA95
    L4_2 = A1_2.openSeWaitTime
    L3_2(L4_2)
  end
  L3_2 = A1_2.openSeName
  if "" ~= L3_2 then
    L3_2 = A1_2.openSeName
    L4_2 = nil
...
function C40C30CBA2F2B9A04_prototype:F3E883E2665129D43(A1_2)
  ...
  L3_2 = A1_2.startObjectName
  L4_2 = A1_2.startCloseState
  L5_2 = A1_2.startStateName
  L6_2 = true
  L2_2(L3_2, L4_2, L5_2, L6_2)
  L2_2 = A1_2.closeSeName
  if "" ~= L2_2 then
    L2_2 = C3A36506FBC96ACBD
    L2_2 = L2_2.SC6181320B46854EE
    L3_2 = A1_2.closeSeName
    L2_2(L3_2)
  end
  L2_2 = A1_2.closeSeEndTime
  if L2_2 > 0 then
    L2_2 = CC6FE82819C6E1D55
    L2_2 = L2_2.S32FAD7D4DF3ACA95
    L3_2 = A1_2.closeSeEndTime
    L2_2(L3_2)
  end
end
...
function C40C30CBA2F2B9A04_prototype:F985DA2396301B398(A1_2)
  ...
  if "" ~= L2_2 then
    L2_2 = C3A36506FBC96ACBD
    L2_2 = L2_2.SC6181320B46854EE
    L3_2 = A1_2.motionStopSeName
    L2_2(L3_2)
  end
  L2_2 = A1_2.motionSeEndTime
  if L2_2 > 0 then
    L2_2 = CC6FE82819C6E1D55
    L2_2 = L2_2.S32FAD7D4DF3ACA95
    L3_2 = A1_2.motionSeEndTime
    L2_2(L3_2)
  end
  L2_2 = A1_2.arrivalSeName
  if "" ~= L2_2 then
    L2_2 = C3A36506FBC96ACBD
    L2_2 = L2_2.SC6181320B46854EE
    L3_2 = A1_2.arrivalSeName
    L2_2(L3_2)
  end
  L2_2 = A1_2.arrivalSeEndTime
  if L2_2 > 0 then
    L2_2 = CC6FE82819C6E1D55
    L2_2 = L2_2.S32FAD7D4DF3ACA95
    L3_2 = A1_2.arrivalSeEndTime
    L2_2(L3_2)
  end
end
...
function C40C30CBA2F2B9A04_prototype:F9709E8657F4B42B5()
  ...
  if nil ~= L1_2 then
    ...
    L4_2 = {}
    L4_2.destScene = true
    L4_2.destLocation = true
    L4_2.destOffset = true
    L4_2.moveOffset = true
    L4_2.startObjectName = true
    L4_2.startStateName = true
    L4_2.startOpenState = true
    L4_2.startCloseState = true
    L4_2.endObjectName = true
    L4_2.endStateName = true
    L4_2.endOpenState = true
    L4_2.endCloseState = true
    L4_2.openSeName = true
    L4_2.openSeWaitTime = true
    L4_2.closeSeName = true
    L4_2.closeSeEndTime = true
    L4_2.motionLoopSeName = true
    L4_2.motionStopSeName = true
    L4_2.motionSeEndTime = true
    L4_2.arrivalSeName = true
    L4_2.arrivalSeEndTime = true
    ...
    L6_2 = "destLocation"
    L4_2 = L4_2(L5_2, L6_2)
    L3_2.destLocation = L4_2
    L4_2 = CA5EA85D96A5EBA15
    L4_2 = L4_2.SCCE7BDD2C72B96F5
    L5_2 = L1_2
    L6_2 = "destOffset"
    L4_2 = L4_2(L5_2, L6_2)
    L3_2.destOffset = L4_2
    L4_2 = CA5EA85D96A5EBA15
    L4_2 = L4_2.SCCE7BDD2C72B96F5
    L5_2 = L1_2
    L6_2 = "moveOffset"
    L4_2 = L4_2(L5_2, L6_2)
    L3_2.moveOffset = L4_2
    L4_2 = CA5EA85D96A5EBA15
    L4_2 = L4_2.S8DCD951C26A2E08E
    L5_2 = L1_2
    L6_2 = "startObjectName"
    L4_2 = L4_2(L5_2, L6_2)
    L3_2.startObjectName = L4_2
    L4_2 = CA5EA85D96A5EBA15
    L4_2 = L4_2.S8DCD951C26A2E08E
    L5_2 = L1_2
    L6_2 = "startStateName"
    L4_2 = L4_2(L5_2, L6_2)
    L3_2.startStateName = L4_2
    L4_2 = CA5EA85D96A5EBA15
    L4_2 = L4_2.S7153C11CA829BCB8
    L5_2 = L1_2
    L6_2 = "startOpenState"
    L4_2 = L4_2(L5_2, L6_2)
    L3_2.startOpenState = L4_2
    L4_2 = CA5EA85D96A5EBA15
    L4_2 = L4_2.S7153C11CA829BCB8
    L5_2 = L1_2
    L6_2 = "startCloseState"
    L4_2 = L4_2(L5_2, L6_2)
    L3_2.startCloseState = L4_2
    L4_2 = CA5EA85D96A5EBA15
    L4_2 = L4_2.S8DCD951C26A2E08E
    L5_2 = L1_2
    L6_2 = "endObjectName"
    L4_2 = L4_2(L5_2, L6_2)
    L3_2.endObjectName = L4_2
    L4_2 = CA5EA85D96A5EBA15
    L4_2 = L4_2.S8DCD951C26A2E08E
    L5_2 = L1_2
    L6_2 = "endStateName"
    L4_2 = L4_2(L5_2, L6_2)
    L3_2.endStateName = L4_2
    L4_2 = CA5EA85D96A5EBA15
    L4_2 = L4_2.S7153C11CA829BCB8
    L5_2 = L1_2
    L6_2 = "endOpenState"
    L4_2 = L4_2(L5_2, L6_2)
    L3_2.endOpenState = L4_2
    L4_2 = CA5EA85D96A5EBA15
    L4_2 = L4_2.S7153C11CA829BCB8
    L5_2 = L1_2
    L6_2 = "endCloseState"
    L4_2 = L4_2(L5_2, L6_2)
    L3_2.endCloseState = L4_2
    L4_2 = CA5EA85D96A5EBA15
    L4_2 = L4_2.S8DCD951C26A2E08E
    L5_2 = L1_2
    L6_2 = "openSeName"
    L4_2 = L4_2(L5_2, L6_2)
    L3_2.openSeName = L4_2
    L4_2 = CA5EA85D96A5EBA15
    L4_2 = L4_2.SAD5CCB7549BC2093
    L5_2 = L1_2
    L6_2 = "openSeWaitTime"
    L4_2 = L4_2(L5_2, L6_2)
    L3_2.openSeWaitTime = L4_2
    L4_2 = CA5EA85D96A5EBA15
    L4_2 = L4_2.S8DCD951C26A2E08E
    L5_2 = L1_2
    L6_2 = "closeSeName"
    L4_2 = L4_2(L5_2, L6_2)
    L3_2.closeSeName = L4_2
    L4_2 = CA5EA85D96A5EBA15
    L4_2 = L4_2.SAD5CCB7549BC2093
    L5_2 = L1_2
    L6_2 = "closeSeEndTime"
    L4_2 = L4_2(L5_2, L6_2)
    L3_2.closeSeEndTime = L4_2
    L4_2 = CA5EA85D96A5EBA15
    L4_2 = L4_2.S8DCD951C26A2E08E
    L5_2 = L1_2
    L6_2 = "motionLoopSeName"
    L4_2 = L4_2(L5_2, L6_2)
    L3_2.motionLoopSeName = L4_2
    L4_2 = CA5EA85D96A5EBA15
    L4_2 = L4_2.S8DCD951C26A2E08E
    L5_2 = L1_2
    L6_2 = "motionStopSeName"
    L4_2 = L4_2(L5_2, L6_2)
    L3_2.motionStopSeName = L4_2
    L4_2 = CA5EA85D96A5EBA15
    L4_2 = L4_2.SAD5CCB7549BC2093
    L5_2 = L1_2
    L6_2 = "motionSeEndTime"
    L4_2 = L4_2(L5_2, L6_2)
    L3_2.motionSeEndTime = L4_2
    L4_2 = CA5EA85D96A5EBA15
    L4_2 = L4_2.S8DCD951C26A2E08E
    L5_2 = L1_2
    L6_2 = "arrivalSeName"
    L4_2 = L4_2(L5_2, L6_2)
    L3_2.arrivalSeName = L4_2
    L4_2 = CA5EA85D96A5EBA15
    L4_2 = L4_2.SAD5CCB7549BC2093
    L5_2 = L1_2
    L6_2 = "arrivalSeEndTime"
    L4_2 = L4_2(L5_2, L6_2)
    L3_2.arrivalSeEndTime = L4_2
    return L2_2(L3_2)
  end
  L2_2 = nil
  return L2_2
...
L69_1 = _ENV["C40C30CBA2F2B9A04"]
L68_1.__class__ = L69_1
L68_1 = _ENV["C40C30CBA2F2B9A04"]
L69_1 = "__super__"
L69_1 = _ENV["C40C30CBA2F2B9A04"]["prototype"]
L70_1 = {}
L71_1 = "__index"
L70_1 = _ENV["C40C30CBA2F2B9A04"]
L68_1[L69_1] = L70_1
L72_1 = _ENV["C40C30CBA2F2B9A04"]["prototype"]
L70_1[L71_1] = L72_1
L68_1(L69_1, L70_1)
