...
function CC03719A3DACA07AF_prototype:F263783F2D3EA118E()
  ...
  L3_2 = L1_2
  L2_2 = L1_2.fEA4CEA94
  L4_2 = CC03719A3DACA07AF
  L4_2 = L4_2.S2B575E9EE2520AF7
  L4_2 = L4_2 + 9
  L2_2(L3_2, L4_2)
  L3_2 = L1_2
  L2_2 = L1_2.fCBA70650
  L4_2 = CC03719A3DACA07AF
  L4_2 = L4_2.S0721D97A0AB7A701
  L2_2(L3_2, L4_2)
  return L1_2
end
...
function CC03719A3DACA07AF_prototype:F26C74E914EA29EF7(A1_2)
  ...
  if 1 == A1_2 then
    ...
    L4_2 = CC03719A3DACA07AF
    L4_2 = L4_2.S3F8F9022D29F9F15
    L3_2.point = L4_2
    L4_2 = CC03719A3DACA07AF
    L4_2 = L4_2.S8EE5691B1186D163
    L3_2.ranking = L4_2
    L3_2.total = 100
    L3_2.win = 50
    L3_2.lose = 50
  ...
  elseif 2 == A1_2 then
    ...
    L3_2.__fields__ = L4_2
    L4_2 = CC03719A3DACA07AF
    L4_2 = L4_2.S3C01F147B384D58C
    L3_2.point = L4_2
    L4_2 = CC03719A3DACA07AF
    L4_2 = L4_2.S5C7B9838A2636486
    L3_2.ranking = L4_2
    L3_2.total = 200
    L3_2.win = 150
    L3_2.lose = 80
...
function CC03719A3DACA07AF_prototype:F97B04BD3F7BB5DE9(A1_2)
  ...
  if 1 == A1_2 then
    L2_2 = CC03719A3DACA07AF
    L2_2 = L2_2.SC8A2C128780F2FEC
    return L2_2
  elseif 2 == A1_2 then
    L2_2 = CC03719A3DACA07AF
    L2_2 = L2_2.S713D344F16F55F8D
    return L2_2
  end
  L2_2 = L16_1
  L3_2 = {}
