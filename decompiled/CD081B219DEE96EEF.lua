...
function CD081B219DEE96EEF.S0FDAC70358D6359B(A0_2)  -- PartyPokeGetFormNo
  ...
  if L5_2 then
    ...
    L2_2 = L1_2:fFD034BC3(A0_2)  -- GetPartyMember
  end
  if c113335A8.fD41E1021(L2_2, nil) then
    return -1
  end
  return L2_2:f5D94E897()  -- GetFormNo
end
...
function CD081B219DEE96EEF.S32A1DC2C486CCFDA(A0_2, A1_2, A2_2)  -- PokemonRecover
...
function CD081B219DEE96EEF.S3BFFB5A4C5D8607A()  -- GetFirstSelectPokeType
  local L0_2 = C10578806AC30DCA3.S971699EB064C6350.h["WEVT_COMMON_0080_FIRST_POKEMON"]  -- C10578806AC30DCA3.s_workCache.h["WEVT_COMMON_0080_FIRST_POKEMON"]
...
function CD081B219DEE96EEF.S7FF7D2284D22450F(A0_2, A1_2)  -- SoundPlayPokeVoice
  return CD081B219DEE96EEF.S59A8891E485C93B9(A0_2, A1_2)  -- SoundPlayPokeVoice2D(A0_2, A1_2)
end

function CD081B219DEE96EEF.S59A8891E485C93B9(A0_2, A1_2, A2_2)  -- SoundPlayPokeVoice2D
  if nil == A2_2 then
    A2_2 = 0
  end
  return cB288EB94.f06001AD7(A0_2, A1_2, A2_2)
end

function CD081B219DEE96EEF.S59A4A31E4858D710(A0_2, A1_2, A2_2, A3_2)  -- SoundPlayPokeVoice3D
  if nil == A3_2 then
    A3_2 = 0
  end
  return cB288EB94.fBEBC7DB2(A0_2[1], A0_2[2], A0_2[3], A1_2, A2_2, A3_2)
end

function CD081B219DEE96EEF.S94156E450AE7DA98(A0_2, A1_2)  -- SoundPlayPokeVoiceFromObject
  local L2_2, L4_2
  if nil == A1_2 then
    A1_2 = 0
  end
  L2_2 = c86CE5CE8.fB41FD22F(A0_2)
  if c86CE5CE8.f54C13BE2(L2_2, nil) then
    L4_2 = A1_2
    if nil == A1_2 then
      L4_2 = 0
    end
    L2_2:f757E37AB(L4_2, 100)
  end
end

function CD081B219DEE96EEF.S7DB0E75245D2DEDB(A0_2, A1_2)  -- SoundPlayPokeVoiceFromObjectName
...
---@param A0_2 fun(item:c113335A8):boolean
---@param A1_2 number @ startIndex
---@return number
function CD081B219DEE96EEF.SFCD07C3AC54C6D17(A0_2, A1_2)  -- partySearch
  if nil == A1_2 then
    A1_2 = 0
  end
  local L2_2 = c1A1CBE3B.fFCE06E04()
  for L3_2 = A1_2, L2_2:f62782BA1() - 1 do
    if A0_2(L2_2:fFD034BC3(L3_2)) then
      return L3_2
    end
  end
  return -1
...
function CD081B219DEE96EEF.S0890DF9181E05ED0(A0_2, A1_2)  -- getPartyPoke
...
function CD081B219DEE96EEF.SA256E1F074BE47CC(A0_2, A1_2, A2_2)
  local L3_2, L4_2, L5_2, L6_2, L7_2, L8_2, L9_2, L10_2, L11_2, L12_2, L13_2, L14_2, L15_2, L16_2, L17_2
  if nil == A2_2 then
    A2_2 = false
  end
...
function CD081B219DEE96EEF.S5443A26EED9DD5BB()
  local L0_2 = C10578806AC30DCA3.S971699EB064C6350.h["WSYS_GEM_CHANGE_POINT"]
  if L0_2 == L47_1.tnull then
    L0_2 = nil
  end
  local L1_2 = C10578806AC30DCA3.S971699EB064C6350.h["WSYS_GEM_CHANGE_POINT_MAX"]
...
function CD081B219DEE96EEF.SFDF40394D1A20D20()  -- PokeGemChangeEnable
  local L0_2 = C10578806AC30DCA3.SBA6FF574C1C9AA09.h["FSYS_GEM_CHANGE_ENABLE"]
  if L0_2 == L47_1.tnull then
    L0_2 = nil
  end
  return L0_2
...
function CD081B219DEE96EEF.S17B638EC0DCEBB73()  -- PokeGemCanChange
  if CD081B219DEE96EEF.SFDF40394D1A20D20() then  -- PokeGemChangeEnable()
    local L0_2 = C10578806AC30DCA3.S971699EB064C6350.h["WSYS_GEM_CHANGE_POINT"]
    if L0_2 == L47_1.tnull then
      L0_2 = nil
    end
...
function CD081B219DEE96EEF.S21ED259696F01A9E(A0_2)
  local L1_2, L2_2, L4_2, L5_2, L6_2, L7_2, L8_2
  L1_2 = A0_2
  L2_2 = C10578806AC30DCA3.S971699EB064C6350.h["WSYS_GEM_CHANGE_POINT_MAX"]
  ...
  L4_2 = C10578806AC30DCA3.SBA6FF574C1C9AA09.h["FSYS_TBALL_POWERUP_ENABLE"]
  if L4_2 == L47_1.tnull then
    L4_2 = nil
  end
  if L4_2 then
    L1_2 = L2_2
  end
  L5_2 = C10578806AC30DCA3.S971699EB064C6350
  if nil == L1_2 then
    L5_2.h["WSYS_GEM_CHANGE_POINT"] = L47_1.tnull
  else
    L5_2.h["WSYS_GEM_CHANGE_POINT"] = L1_2
  end
  c37452BA0.f8A7498B1("WSYS_GEM_CHANGE_POINT", L1_2)
  return L1_2
end

function CD081B219DEE96EEF.S53E4F8D10689FDAA(A0_2)
...
function CD081B219DEE96EEF.SA105F0B7C6E3E892(A0_2, A1_2, A2_2)
  CD081B219DEE96EEF.S352F9A18488377D2(A2_2)
  CD081B219DEE96EEF.S32A7EFF2172D892C(A0_2, A1_2, CD081B219DEE96EEF.SEF9F3FAEDA3F8BB1(A2_2))  -- PokeSetRibbon(...)
end

function CD081B219DEE96EEF.S6C581AE98BBAA072(A0_2, A1_2, A2_2)
...
function CD081B219DEE96EEF.S32A7EFF2172D892C(A0_2, A1_2, A2_2)  -- PokeSetRibbon
...
function CD081B219DEE96EEF.S49EDBBE4C623A7CC(A0_2, A1_2, A2_2)  -- PokeIsRibbon
  local L3_2, L4_2, L5_2, L6_2, L7_2, L8_2
  L3_2 = false
  L4_2 = CD081B219DEE96EEF
...
function CD081B219DEE96EEF.S85112EB8E05F6A41(A0_2, A1_2)
  local L2_2, L3_2, L4_2, L5_2, L6_2, L7_2
  L2_2 = 0
  L3_2 = CD081B219DEE96EEF
  L3_2 = L3_2.S5D3812A8BCAB4D5D
...
function CD081B219DEE96EEF.S8C9F9009A1B363DA(A0_2, A1_2)  -- PokeGetFriendship
  local L2_2, L3_2, L4_2, L5_2, L6_2, L7_2
  L2_2 = 0
  L3_2 = CD081B219DEE96EEF
  L3_2 = L3_2.S5D3812A8BCAB4D5D
...
function CD081B219DEE96EEF.SD58C73D8A6D6E00C(A0_2, A1_2)
  local L2_2, L3_2, L4_2, L5_2, L6_2, L7_2
  L2_2 = 0
  L3_2 = CD081B219DEE96EEF
  L3_2 = L3_2.S5D3812A8BCAB4D5D
...
function CD081B219DEE96EEF.S5D3812A8BCAB4D5D(A0_2, A1_2)  -- GetPokeBoxParty
...
function CD081B219DEE96EEF.S771CD14B5B151D25(A0_2)  -- OpenBoxSelectMode
...
function CD081B219DEE96EEF.S91E00EED6D26A407(A0_2, A1_2, A2_2)  -- SetPokeBox
  local L3_2, L4_2, L5_2, L6_2
  if -1 ~= A0_2 then
    L3_2 = c1A1CBE3B
    L3_2 = L3_2.fA4BF8173
...
function CD081B219DEE96EEF.S644D748FB7CE5439(A0_2, A1_2, A2_2)  -- ReplacePokeBoxParty
  local L3_2, L4_2, L5_2, L6_2, L7_2, L8_2
  if -1 ~= A0_2 then
...
function CD081B219DEE96EEF.SC89FCE5A160EDEE4(A0_2)  -- PokeAddPokemon
  local L1_2, L2_2, L3_2, L4_2, L5_2, L6_2
  L1_2 = L16_1
  L2_2 = {}
  L3_2 = {}
...
function CD081B219DEE96EEF.S26F7CFAD80CEB121(A0_2)
  local L1_2, L2_2
...
function CD081B219DEE96EEF.SEF9F3FAEDA3F8BB1(A0_2)
...
function CD081B219DEE96EEF.S352F9A18488377D2(A0_2)
  local L1_2, L2_2
  if 3 == A0_2 then
...
function CD081B219DEE96EEF.S88E21E664BC88DAA(A0_2)  -- ShallowCopy
  local L1_2, L2_2, L3_2, L4_2, L5_2, L6_2
  L1_2 = cC99399C3
  L1_2 = L1_2.f101D811F
  L1_2 = L1_2()
...
function CD081B219DEE96EEF.S52C07E589A27A741()  -- SaveFirstIguana
  local L0_2

  if 0 == cDD25B9DB.f4F92E4A5() then
    L0_2 = "gameclear_AIGUANA"
  else
    L0_2 = "gameclear_BIGUANA"
  end

  L0_2 = C08F1D9E725844275.S1AB37D4C4C86A619(L0_2)  -- main.field.behaviour.add_pokemon.AddPokemonManager.GetAddPokePara(L0_2)
  c5F9AB88A.fDBC35321(L0_2, 0, C9021E7F99581DB97.SDA35F5D36FE7531F())  -- C9021E7F99581DB97.GetNowPlaceNo()
  cCDB92DE8.fBF657742(L0_2)
end
