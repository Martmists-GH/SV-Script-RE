...
function L70_1(A0_2)
  ...
  if 0 == L1_2 then
    ...
    L4_2 = A0_2
    L3_2 = A0_2.F2E74AD44BBEE7DDC
    L5_2 = A0_2[5]
    L6_2 = A0_2[7]
    L3_2 = L3_2(L4_2, L5_2, L6_2)
    if L3_2 then
      L4_2 = A0_2
      L3_2 = A0_2.FFCFFC8EA4D1EEC85
      L5_2 = A0_2[11]
      L3_2(L4_2, L5_2)
      A0_2[6] = 1
      return
  ...
  elseif 3 == L1_2 then
    ...
    if 0 ~= L2_2 then
      ...
      L3_2(L4_2, L5_2)
      L4_2 = A0_2
      L3_2 = A0_2.F22A4D2F78EE0B990
      L5_2 = true
      L3_2(L4_2, L5_2)
      if 3 ~= L2_2 then
        L4_2 = A0_2
        L3_2 = A0_2.F4814C94D0A1D1C1B
        L3_2(L4_2)
      end
      if 1 == L2_2 then
  ...
  elseif 4 == L1_2 then
    ...
    if L2_2 then
      ...
      L2_2(L3_2, L4_2)
      L3_2 = A0_2
      L2_2 = A0_2.F22A4D2F78EE0B990
      L4_2 = false
      L2_2(L3_2, L4_2)
      L3_2 = A0_2
      L2_2 = A0_2.F32DF2E29928616A5
      L4_2 = A0_2[9]
      L5_2 = A0_2[5]
      L2_2(L3_2, L4_2, L5_2)
    end
