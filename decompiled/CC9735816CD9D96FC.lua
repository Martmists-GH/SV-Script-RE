...
function CC9735816CD9D96FC.SD40D3A64E8B633BD(A0_2, A1_2, A2_2, A3_2, A4_2, A5_2)
  ...
  if L13_2 then
    L14_2 = L10_2
    L13_2 = L10_2.f7B8E55B0
    L13_2 = L13_2(L14_2)
    L14_2 = CC9735816CD9D96FC
    L14_2 = L14_2.S9EDA2451F5064C21
    if L13_2 ~= L14_2 then
      return
    end
    L14_2 = L10_2
    L13_2 = L10_2.fE3420658
    L13_2 = L13_2(L14_2)
    if L13_2 ~= A5_2 then
      return
    end
  ...
  L14_2 = L8_2
  L13_2 = L8_2.fE9C29DA1
  L13_2 = L13_2(L14_2)
  if "PlayerEventTrigger" == L13_2 then
    L7_2[4] = A3_2
    if A3_2 then
      L13_2 = C42D1CDB112422850
      L13_2 = L13_2.S21B2E00A427D24BD
      L13_2()
    else
      L13_2 = C42D1CDB112422850
      L13_2 = L13_2.S2E89DD1F7763EC80
      L13_2()
    end
  end
end
...
L68_1 = _ENV["CC9735816CD9D96FC"]
L69_1 = "__super__"
L69_1 = _ENV["CC9735816CD9D96FC"]["prototype"]
L70_1 = {}
L71_1 = "__index"
