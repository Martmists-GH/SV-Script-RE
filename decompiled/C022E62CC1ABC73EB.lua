---@alias C022E62CC1ABC73EB main_battle_director_BattleTrainerEncount

---@class main_battle_director_BattleTrainerEncount : C022E62CC1ABC73EB_prototype
---@field prototype C022E62CC1ABC73EB_prototype
L55_1 = _ENV
...
---@class C022E62CC1ABC73EB_prototype
C022E62CC1ABC73EB_prototype = L15_1()
C022E62CC1ABC73EB.prototype = C022E62CC1ABC73EB_prototype
--- main.battle.director.BattleTrainerEncount.PlayCore
function C022E62CC1ABC73EB_prototype:F62979ACB82B7C708()
...
--- main.battle.director.BattleTrainerEncount.Update
function C022E62CC1ABC73EB_prototype:FEB6685558281F194()
  ...
  if 0 == L1_2 then
    ...
    if L4_2 then
      ...
      L4_2 = L4_2[2]
      if 2 == L4_2 then
        L2_2 = "demo/ee/ee314/ee314.trtml"
      end
    else
      L4_2 = self[1]
      L5_2 = L4_2
      ...
      if L4_2 then
        ...
        L4_2 = L4_2[135]
        if 2 ~= L4_2 then
          L2_2 = "demo/ee/ee346/ee346.trtml"
        else
          L2_2 = "demo/ee/ee347/ee347.trtml"
        end
      end
    end
    L4_2 = L26_1.new
    ...
    while L4_2 < L5_2 do
      ...
      if L8_2 then
        ...
        if 1 == L8_2 then
          ...
          L8_2 = L8_2[9]
          L9_2 = L8_2
          L8_2 = L8_2.FE4A7118C3BDDBA97
          L10_2 = self[17]
          L10_2 = L10_2[L6_2]
          L8_2 = L8_2(L9_2, L10_2)
          L10_2 = L7_2
          L9_2 = L7_2.F7E935E60C135F1D3
          L11_2 = true
          L12_2 = {}
          L13_2 = L8_2[1]
          L14_2 = L8_2[2]
  ...
  elseif 7 == L1_2 then
    ...
    if L6_2 then
      ...
      L6_2 = L6_2[2]
      if 2 == L6_2 then
        L4_2 = "effect/battle_ee/ee403/ee403.trsot"
        L5_2 = "demo/ee/ee405/ee405.trtml"
      end
    else
      L6_2 = self[1]
      L7_2 = L6_2
      ...
      if L6_2 then
        ...
        if 2 ~= L6_2 then
          L4_2 = "effect/battle_ee/ee403/ee403.trsot"
          L5_2 = "demo/ee/ee406/ee406.trtml"
        else
          L4_2 = "effect/battle_ee/ee404/ee404.trsot"
          L5_2 = "demo/ee/ee407/ee407.trtml"
        end
      end
    end
    L6_2 = self[2]
