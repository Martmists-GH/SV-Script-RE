---@class C136DD0FD852519B0 : C136DD0FD852519B0_prototype
---@field prototype C136DD0FD852519B0_prototype
L55_1 = _ENV
...
---@class C136DD0FD852519B0_prototype
C136DD0FD852519B0_prototype = L15_1()
C136DD0FD852519B0.prototype = C136DD0FD852519B0_prototype
--- C136DD0FD852519B0.mainBody
function C136DD0FD852519B0_prototype:FD8D5F3745B4B5174()
  ...
  if "event_npc_gym_mizu_receptionist" == L1_2 then
    ...
    if L1_2 then
      L4_2 = self
      L3_2 = self.FF49FDBC545623217
      L3_2(L4_2)
    elseif L2_2 then
      L4_2 = self
      L3_2 = self.F14899B9324AD7699
      L3_2(L4_2)
    else
      L3_2 = L31_1.string
      L4_2 = L31_1.string
      ...
      L5_2 = self[18]
      L5_2 = L5_2.ownerName
      L6_2 = "gym_mizu_040_receptionist_00"
      L7_2 = self[36]
      L8_2 = 0
...
--- C136DD0FD852519B0.eventFinished
function C136DD0FD852519B0_prototype:F14899B9324AD7699()
...
--- C136DD0FD852519B0.event020
function C136DD0FD852519B0_prototype:FF49FDBC545623217()
  local L1_2, L2_2, L3_2, L4_2, L5_2, L6_2, L7_2, L8_2
  L1_2 = L31_1.string
  L2_2 = L31_1.string
  L3_2 = "message/dat/JPN/script/"
