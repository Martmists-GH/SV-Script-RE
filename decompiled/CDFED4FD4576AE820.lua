...
function CDFED4FD4576AE820.S3FEEFB06B65D4728(A0_2)
  ...
  if 3 == A0_2 then
    ...
    L1_2 = L1_2.S266E709FF2040F8E
    L1_2()
    return
  end
  if 4 == A0_2 then
    L1_2 = CDFED4FD4576AE820
    L1_2 = L1_2.SD19EB2BA42D6CB1B
    L1_2()
    return
  end
...
function CDFED4FD4576AE820.S266E709FF2040F8E()
  ...
  L3_2 = L3_2(L4_2, L5_2)
  L4_2 = L31_1.string
  L5_2 = "Scene Not found "
  L4_2 = L4_2(L5_2)
  L5_2 = L31_1.string
  L6_2 = "ymap_mission_demo_su1"
  L5_2 = L5_2(L6_2)
  L4_2 = L4_2 .. L5_2
  L2_2(L3_2, L4_2)
  L3_2 = L0_2
  ...
  L4_2 = L52_1.__cast
  L5_2 = L3_2
  L6_2 = C59F28474AD75722A
  L4_2 = L4_2(L5_2, L6_2)
  while true do
    L6_2 = L4_2
    L5_2 = L4_2.F49AB1A730C0CD5BD
    L5_2 = L5_2(L6_2)
    if false ~= L5_2 then
      break
    end
