---@alias CC704789D12A0E0F2 main_util_tween_TweenUtil

---@class main_util_tween_TweenUtil : CC704789D12A0E0F2_prototype
---@field prototype CC704789D12A0E0F2_prototype
L55_1 = _ENV
...
L26_1---@class CC704789D12A0E0F2_prototype
CC704789D12A0E0F2_prototype = L15_1()
CC704789D12A0E0F2.prototype = CC704789D12A0E0F2_prototype
L26_1[L68_1] = L69_1
L68_1 = "prototype"
L68_1 = L26_1[L68_1]
L69_1 = "concat"
...
function L69_1(self, A1_2)
  ...
  if self == A1_2 then
    L2_2 = 0
    return L2_2
  elseif nil == self then
    L2_2 = -1
    return L2_2
  elseif nil == A1_2 then
    L2_2 = 1
    return L2_2
  elseif A1_2 < self then
    L2_2 = 1
    return L2_2
  else
    L2_2 = -1
...
function L69_1(self)
  local L1_2, L2_2, L3_2, L4_2, L5_2, L6_2, L7_2
  L1_2 = self.__empty_constructs__
  L2_2 = _hx_tab_array
  L3_2 = {}
  L3_2.length = 0
  L4_2 = 0
...
L70_1 = L15_1
L70_1 = L70_1()
--- main.util.tween.TweenUtil.mainCoroutineFunc
function CC704789D12A0E0F2_prototype:F9EF8B08DA4FDA9E4()
  local L1_2
end

--- main.util.tween.TweenUtil.Move
function CC704789D12A0E0F2_prototype:F54D82E924D2D26F4(A1_2, A2_2)
  local L3_2, L4_2, L5_2, L6_2
  L4_2 = self
  L3_2 = self.F9518230B6FB5261C
  L5_2 = A1_2
  L6_2 = A2_2
  L3_2(L4_2, L5_2, L6_2)
  return self
...
--- main.util.tween.TweenUtil.MoveSpeed
function CC704789D12A0E0F2_prototype:F03B84A395F29061F(A1_2, A2_2)
...
--- main.util.tween.TweenUtil.CreateCoroutineMove
function CC704789D12A0E0F2_prototype:F9518230B6FB5261C(A1_2, A2_2)
...
--- main.util.tween.TweenUtil.SimpleValue
function CC704789D12A0E0F2_prototype:F7364C99F171973B4(A1_2, A2_2)
  local L3_2, L4_2, L5_2, L6_2
  if nil == A2_2 then
    A2_2 = 1
  end
  L4_2 = self
  L3_2 = self.FA78D947F4150F8AC
  L5_2 = A1_2
  L6_2 = A2_2
  L3_2(L4_2, L5_2, L6_2)
  return self
...
--- main.util.tween.TweenUtil.CreateCoroutineSimpleValue
function CC704789D12A0E0F2_prototype:FA78D947F4150F8AC(A1_2, A2_2)
  local L3_2, L4_2, L5_2, L6_2, L7_2, L8_2, L9_2
  if nil == A2_2 then
    A2_2 = 1
  end
...
--- main.util.tween.TweenUtil.OnUpdateSimpleValue
function CC704789D12A0E0F2_prototype:F9DDCAC6FC1A43090(A1_2, A2_2)
  local L3_2, L4_2, L5_2, L6_2
  self[15] = A1_2
  ...
  if nil ~= L3_2 then
    ...
    L3_2[2] = A2_2
    L5_2 = self
    L4_2 = self.FC0150FC2959FFA71
    L6_2 = L3_2
    L4_2(L5_2, L6_2)
  end
end

--- main.util.tween.TweenUtil.PathMove
function CC704789D12A0E0F2_prototype:FAC621C7266E79083(A1_2, A2_2, A3_2)
...
--- main.util.tween.TweenUtil.PathMoveSpeed
function CC704789D12A0E0F2_prototype:FC072C58126BE9CDE(A1_2, A2_2, A3_2)
  local L4_2, L5_2, L6_2, L7_2, L8_2, L9_2, L10_2, L11_2, L12_2, L13_2, L14_2, L15_2, L16_2, L17_2
  if nil == A3_2 then
    L4_2 = E09A82F76179381A5
    A3_2 = L4_2.Linear
...
--- main.util.tween.TweenUtil.CreateCoroutinePathMove
function CC704789D12A0E0F2_prototype:F9DFDAED23135909B(A1_2, A2_2, A3_2, A4_2)
  local L5_2, L6_2, L7_2, L8_2, L9_2, L10_2, L11_2, L12_2
  L5_2 = self
  L7_2 = self
  L6_2 = self.FBD85BEF51374A611
  L6_2(L7_2)
  L6_2 = 0
  L7_2 = _hx_tab_array
  L8_2 = {}
...
--- main.util.tween.TweenUtil.PathBehavior
function CC704789D12A0E0F2_prototype:F00F0C05722388FD0(A1_2, A2_2, A3_2, A4_2, A5_2, A6_2)
  ...
  while true do
    ...
    L18_2 = self
    L17_2 = self.FEB8CC4C5E87224B0
    L19_2 = A1_2
    L20_2 = A6_2
    L17_2(L18_2, L19_2, L20_2)
    L17_2 = self.FC0150FC2959FFA71
    if nil ~= L17_2 then
      L18_2 = self
      L17_2 = self.FC0150FC2959FFA71
      L19_2 = nil
...
--- main.util.tween.TweenUtil.CreateCoroutinePathCatmullRomMove
function CC704789D12A0E0F2_prototype:F4BA557BEDCE27B8F(A1_2, A2_2, A3_2, A4_2)
...
--- main.util.tween.TweenUtil.F1E63964EEBFB0827
function CC704789D12A0E0F2_prototype:F1E63964EEBFB0827(A1_2, A2_2, A3_2)
  ...
  if nil ~= L4_2 then
    ...
    L4_2[4] = L5_2
    L6_2 = self
    L5_2 = self.FC0150FC2959FFA71
    L7_2 = L4_2
    L5_2(L6_2, L7_2)
  end
end

--- main.util.tween.TweenUtil.TweenUpDate
function CC704789D12A0E0F2_prototype:F3BC3E2DE6CE68A7D(A1_2)
  local L2_2, L3_2, L4_2
  L2_2 = self[4]
  if nil ~= L2_2 then
...
--- main.util.tween.TweenUtil.Pause
function CC704789D12A0E0F2_prototype:F7B1493ADECD2288D()
  local L1_2, L2_2
  L1_2 = self[12]
  if not L1_2 then
    L1_2 = self[6]
...
--- main.util.tween.TweenUtil.Resume
function CC704789D12A0E0F2_prototype:F3C93DF9C47B1912A()
...
--- main.util.tween.TweenUtil.kill
function CC704789D12A0E0F2_prototype:FB50C9ACDC127E3B9()
  local L1_2
  self.FC0150FC2959FFA71 = nil
  self.F9C2061D76FBA5293 = nil
  self.F0085F7055F019927 = nil
  self[7] = true
  self[4] = nil
end

--- main.util.tween.TweenUtil.ResetParam
function CC704789D12A0E0F2_prototype:FBD85BEF51374A611()
  local L1_2
  self[7] = false
  self[8] = 1
...
--- main.util.tween.TweenUtil.F8F99AB5A87FDD37E
function CC704789D12A0E0F2_prototype:F8F99AB5A87FDD37E(A1_2, A2_2)
end

--- main.util.tween.TweenUtil.DebugTweenPath
function CC704789D12A0E0F2_prototype:FEB8CC4C5E87224B0(A1_2, A2_2)
  local L3_2, L4_2
  L3_2 = self[19]
  if L3_2 then
    L3_2 = 0
...
--- main.util.tween.TweenUtil.OnUpdate
function CC704789D12A0E0F2_prototype:FE1B998C2DEC49E51(A1_2)
  local L2_2, L3_2
  L2_2 = L58_1
  L3_2 = A1_2
  L2_2 = L2_2(L3_2)
...
--- main.util.tween.TweenUtil.OnComplete
function CC704789D12A0E0F2_prototype:FDFC20666B86B7107(A1_2)
  local L2_2, L3_2
  L2_2 = L58_1
  L3_2 = A1_2
  L2_2 = L2_2(L3_2)
...
--- main.util.tween.TweenUtil.OnPathChange
function CC704789D12A0E0F2_prototype:FB9D98BF22BC68DB3(A1_2)
  local L2_2, L3_2
  L2_2 = L58_1
  L3_2 = A1_2
  L2_2 = L2_2(L3_2)
  self.F9C2061D76FBA5293 = L2_2
  return self
end

--- main.util.tween.TweenUtil.SetLoop
function CC704789D12A0E0F2_prototype:F57B13B315CA6E9B1(A1_2, A2_2)
  local L3_2
  if nil == A2_2 then
...
--- main.util.tween.TweenUtil.SetLockAt
function CC704789D12A0E0F2_prototype:FE870683EDFC111F9(A1_2)
  self[10] = A1_2
  return self
end

--- main.util.tween.TweenUtil.SetEase
function CC704789D12A0E0F2_prototype:F74C093E903CBE9F1(A1_2)
  if nil == A1_2 then
    A1_2 = 0
  end
  self[11] = A1_2
...
--- main.util.tween.TweenUtil.FAF4BE2DC56EF92ED
function CC704789D12A0E0F2_prototype:FAF4BE2DC56EF92ED(A1_2, A2_2, A3_2)
  local L4_2
  if nil == A3_2 then
    A3_2 = 30
  end
