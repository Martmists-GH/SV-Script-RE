...
---@field f9E160020 fun(self:self,x:PokemonParam):boolean @ AddMember
---@field f36E12C71 fun(self:self,x:number,y:PokemonParam):void
...
---@field f0FDE774D fun(self:self,x:number):PokemonParam @ GetMemberPointerConst
---@field fFD034BC3 fun(self:self,x:number):PokemonParam @ GetMemberPointer   -- unsure which of the two is const
...
---@field f67D208C2 fun(self:self,x:PokemonParam):number @ GetMemberIndex
---@field fCB4D9397 fun(self:self):boolean @ IsFull
---@field fEFB3ECFD fun(self:self,x:PokeParty):void @ CopyFrom
