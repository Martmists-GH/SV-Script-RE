...
function CF1D074B6B410BDB8.S2E71AD9087CC54E3(A0_2, A1_2, A2_2, A3_2, A4_2)
  ...
  if 105 == L6_2 then
    ...
    while L9_2 < L10_2 do
      ...
      L11_2 = L9_2 - 1
      L13_2 = L6_2
      L12_2 = L6_2.f529CF7BF
      L14_2 = L11_2
      L15_2 = 0
      L12_2 = L12_2(L13_2, L14_2, L15_2)
      L14_2 = L6_2
      L13_2 = L6_2.f529CF7BF
      L15_2 = L11_2
      L16_2 = 1
  ...
  if 103 == L6_2 then
    ...
    L7_2 = L7_2.SCFC7BBA5F416B71B
    if nil ~= L7_2 then
      L9_2 = L7_2
      L8_2 = L7_2.F4E61560C81D929C5
      L10_2 = L5_2
      L12_2 = L6_2
      L11_2 = L6_2.f91B15A24
  ...
  L6_2 = CA854ADB0543ACD17
  L6_2 = L6_2.S3E17F096DEB91208
  L8_2 = A3_2
  L7_2 = A3_2.fF4828D12
...
function CF1D074B6B410BDB8.S2EC71873A8E430A2(A0_2)
  ...
  if L4_2 then
    ...
    L7_2 = {}
    L7_2.length = 0
    L7_2[0] = "other_player_0"
    L8_2 = "other_player_1"
    L9_2 = "other_player_2"
    L10_2 = "other_player_3"
    L7_2[1] = L8_2
    L7_2[2] = L9_2
    L7_2[3] = L10_2
    L8_2 = 4
...
function CF1D074B6B410BDB8.SFB44C6946D2C6806(A0_2, A1_2)
  ...
  if L7_2 then
    ...
    L10_2 = {}
    L10_2.length = 0
    L10_2[0] = "other_player_0"
    L11_2 = "other_player_1"
    L12_2 = "other_player_2"
    L13_2 = "other_player_3"
    L10_2[1] = L11_2
    L10_2[2] = L12_2
    L10_2[3] = L13_2
    L11_2 = 4
...
function CF1D074B6B410BDB8.SB5CCA001615BA618(A0_2)
  ...
  if L2_2 == L3_2 then
    if 1 == L2_2 then
      ...
      L5_2 = L5_2.S850F8BE74EB76F39
      L6_2 = L3_2
      L5_2 = L5_2(L6_2)
      L6_2 = CE506B90C88D90C92
      L6_2 = L6_2.S850F8BE74EB76F39
      L7_2 = L4_2
      L6_2 = L6_2(L7_2)
      if true == L5_2 then
        if true == L6_2 then
          L7_2 = CE506B90C88D90C92
          L7_2 = L7_2.S51AE641617D26AF5
          L8_2 = L4_2
          L7_2 = L7_2(L8_2)
          if true == L7_2 then
            L7_2 = true
      ...
      if not L1_2 then
        ...
        if not L1_2 then
          ...
          if L2_2 then
            ...
            L2_2 = L2_2.fE9C29DA1
            L2_2 = L2_2(L3_2)
            if "a_sch_2_entrance01" ~= L2_2 then
              L2_2 = false
              return L2_2
            end
          end
...
function CF1D074B6B410BDB8_prototype:FE94F3E13286232CF(A1_2)
  ...
  elseif 4 == L2_2 then
    ...
    L3_2 = C05C7D15ECE099E1D
    L3_2 = L3_2.SD2B46D83E7DBCC8F
    L3_2 = L3_2()
    if L3_2 then
      return
    end
    ...
    L3_2 = L3_2.h
    L3_2 = L3_2.FEVT_S2_SUB_041_TUTORIAL
    L4_2 = L47_1.tnull
    if L3_2 == L4_2 then
      L3_2 = nil
    end
