---@alias C941D98474F5C3140 main_battle_director_BattleTalkDirector

---@class main_battle_director_BattleTalkDirector : C941D98474F5C3140_prototype
---@field prototype C941D98474F5C3140_prototype
L55_1 = _ENV
...
---@class C941D98474F5C3140_prototype
C941D98474F5C3140_prototype = L15_1()
C941D98474F5C3140.prototype = C941D98474F5C3140_prototype
--- main.battle.director.BattleTalkDirector.PlayCore
function C941D98474F5C3140_prototype:F62979ACB82B7C708()
  local L1_2
end

--- main.battle.director.BattleTalkDirector.Update
function C941D98474F5C3140_prototype:FEB6685558281F194()
  ...
  if 0 == L1_2 then
    ...
    L2_2(L3_2)
    L3_2 = self
    L2_2 = self.FF7DB48C35164A2B9
    L2_2(L3_2)
    L3_2 = self
    L2_2 = self.F24DC7DD3C52B4FBF
    L2_2(L3_2)
...
--- main.battle.director.BattleTalkDirector.FF7DB48C35164A2B9
function C941D98474F5C3140_prototype:FF7DB48C35164A2B9()
...
--- main.battle.director.BattleTalkDirector.DispBossGauge
function C941D98474F5C3140_prototype:F0A96C4AF8C435487()
...
--- main.battle.director.BattleTalkDirector.HideBossGauge
function C941D98474F5C3140_prototype:F24DC7DD3C52B4FBF()
  local L1_2, L2_2, L3_2, L4_2, L5_2
  L1_2 = self[1]
  L1_2 = L1_2[12]
  L2_2 = L1_2
