...
function L70_1(A0_2)
  ...
  if "\227\130\183\227\131\179\227\130\176\227\131\171" == L1_2 then
    ...
    if L2_2 then
      L3_2 = A0_2
      L2_2 = A0_2.FCF83DA4D0375A58D
      L2_2 = L2_2(L3_2)
      A0_2[7] = L2_2
    else
      L3_2 = A0_2
      L2_2 = A0_2.FC351BA4A5A3F47A9
      L2_2 = L2_2(L3_2)
      A0_2[7] = L2_2
    end
    L2_2 = A0_2[7]
  ...
  elseif "\227\131\128\227\131\150\227\131\171" == L1_2 then
    ...
    if L2_2 then
      L3_2 = A0_2
      L2_2 = A0_2.FE7428C396640A294
      L2_2 = L2_2(L3_2)
      A0_2[7] = L2_2
    else
      L3_2 = A0_2
      L2_2 = A0_2.F8DFD8F0A8389C3A8
      L2_2 = L2_2(L3_2)
      A0_2[7] = L2_2
    end
    L2_2 = A0_2[7]
  ...
  elseif "\227\131\158\227\131\171\227\131\129" == L1_2 then
    ...
    if L2_2 then
      L3_2 = A0_2
      L2_2 = A0_2.F973A0E69CF883DDE
      L2_2 = L2_2(L3_2)
      A0_2[7] = L2_2
    else
      L3_2 = A0_2
      L2_2 = A0_2.F25ED6D6B3E4A00F2
      L2_2 = L2_2(L3_2)
      A0_2[7] = L2_2
    end
    L2_2 = A0_2[7]
