-- main.ui.btlspot.ui.BattleSpotUICategory
CFEE96EBF54E0C712 = L15_1()

function CFEE96EBF54E0C712.new(A0_2)
  L1_2 = L2_1(CFEE96EBF54E0C712.prototype, 9, 47)
...
function CFEE96EBF54E0C712.prototype.F798CCA603D6E6730(self, A1_2)  -- SetupUI
  if c3FAF3463.f8C71328E(self[9], nil) then
    self[9] = C04C2A679B8598CA6.SD071DF9D0379766A(self[1], 5, false)
  end
end

function CFEE96EBF54E0C712.prototype.F96EA28F400597FA0(self, A1_2, A2_2)  -- Reset
  local L3_2, L4_2, L7_2
  c8C3BF576.f46674724(self[1], "T_area_01", "btlspot", "msg_ui_btlspot_entryoption_select_preview_01")
  L3_2 = self:F21738E70349B6593(A2_2)
  if L3_2 ~= nil then
  ...
  if A1_2 == 1 then
    ...
    L4_2 = cECD2E4A5.fD4E920D9(self[1], "Cursor_00")
  ...
  L7_2 = c8C3BF576.fC8CEF9EF("btlspot", "msg_ui_btlspot_help_03")
...
function CFEE96EBF54E0C712.prototype.F7EED485852A4D25F(self)  -- Start
  self:F6FCE9E4187792625(true)
end

function CFEE96EBF54E0C712.prototype.FEB6685558281F194(self, A1_2)  -- Update
  if not A1_2 then
    self:F6FCE9E4187792625(false)
    return -1
  end
...
function CFEE96EBF54E0C712.prototype.F21738E70349B6593(self, A1_2)
  local L4_2, L6_2
  if A1_2.resultArea == 0 then
    return nil
  elseif A1_2.resultArea == 1 or A1_2.resultArea == 7 then
    L6_2 = C6EC1A2D33C58AA58.S54C29A2006B8B5DB()
    return L6_2[A1_2.resultArea - 1].label
  end
  L4_2 = C6EC1A2D33C58AA58.S45013FE5B4A9A8BC(A1_2.resultArea)
...
function CFEE96EBF54E0C712.prototype.FF7E785D2BCAE4FCF(self, A1_2)
...
CFEE96EBF54E0C712.prototype.__class__ = CFEE96EBF54E0C712
CFEE96EBF54E0C712.__super__ = CC7F8D431270AC472
setmetatable(CFEE96EBF54E0C712.prototype, {__index = CC7F8D431270AC472})
