...
function C993132C07A4F918E_prototype:FD8D5F3745B4B5174()
  ...
  if L2_2 then
    ...
    L3_2 = "BlackFade"
    L4_2 = C993132C07A4F918E
    L4_2 = L4_2.SDE0E700E523E36AF
    L2_2(L3_2, L4_2)
  end
  ...
  if nil == L2_2 then
    ...
    if "oniballoon" == L2_2 then
      ...
      L4_2 = L2_2
      L3_2 = L2_2.F4E804A7EC852E4F9
      L3_2(L4_2)
    else
      L2_2 = C42D1CDB112422850
      L2_2 = L2_2.SB1B0B792BAC0AE86
      L2_2 = L2_2()
      if "kuma_fieldwork" == L2_2 then
...
function C993132C07A4F918E_prototype:FF3A941DC9D41B32A()
  ...
  L2_2 = "BlackFade"
  L3_2 = C993132C07A4F918E
  L3_2 = L3_2.SDE0E700E523E36AF
  L1_2(L2_2, L3_2)
  L1_2 = cB66A3C78
  L1_2 = L1_2.fA925EE56
  L1_2 = L1_2()
  ...
  L2_2 = "message/dat/JPN/common/gameover.dat"
  L1_2(L2_2)
  L1_2 = C9B54BC04DD492B6D
  ...
  if L1_2 then
    L1_2 = C9B54BC04DD492B6D
    L1_2 = L1_2.S6BD3B70E1664C014
    L2_2 = "msg_all_dead_05"
    L3_2 = "gameover"
    L4_2 = nil
    L5_2 = nil
    L6_2 = nil
...
function C993132C07A4F918E_prototype:F972B30D9DE428BA8()
  ...
  L2_2 = {}
  L3_2 = {}
  L3_2.mapChangeInfo = true
  L3_2.forcePosition = true
  L3_2.forceRotation = true
  ...
  L5_2.type = true
  L5_2.destScene = true
  L5_2.destLocation = true
  L5_2.destOffset = true
  ...
  L2_2 = L2_2.SB1B0B792BAC0AE86
  L2_2 = L2_2()
  if "gym_mushi" == L2_2 then
    L2_2 = C97020DF9B90A5322
    L2_2 = L2_2.S74FEA38453D86E00
    L3_2 = false
    L2_2(L3_2)
    L2_2 = C42D1CDB112422850
    L2_2 = L2_2.SBFEBD268F15274EC
    L3_2 = true
    L2_2(L3_2)
  else
    L2_2 = C42D1CDB112422850
    L2_2 = L2_2.SB1B0B792BAC0AE86
    L2_2 = L2_2()
    if "gym_koori" == L2_2 then
      L2_2 = C5648AAEE3425CE6C
      L2_2 = L2_2.SE520EA6407A67718
      L3_2 = true
      L2_2(L3_2)
      while true do
      ...
      L2_2 = L2_2.SB1B0B792BAC0AE86
      L2_2 = L2_2()
      if "gym_kusa" == L2_2 then
        L2_2 = CF6989DEF87EEA6AA
        L2_2 = L2_2.S0DD2D1A5EB4B5B24
        L2_2()
        L2_2 = C42D1CDB112422850
        L2_2 = L2_2.SBFEBD268F15274EC
        L3_2 = true
        ...
        if "oniballoon" == L2_2 then
          ...
          L2_2 = L2_2.SB1B0B792BAC0AE86
          L2_2 = L2_2()
          if "honoo_challenge" == L2_2 then
            L2_2 = CACC66432E3F15E9E
            L2_2 = L2_2.SE2FB94D72F34E05D
            L2_2()
            L2_2 = C42D1CDB112422850
            L2_2 = L2_2.SBFEBD268F15274EC
            L3_2 = true
...
function C993132C07A4F918E_prototype:F8AB295270FA49076()
  ...
  L11_2.offset = L12_2
  L12_2 = c37452BA0
  L12_2 = L12_2.fA9C59B30
  L13_2 = L1_2.rot
  L12_2 = L12_2(L13_2)
  L11_2.rot = L12_2
  L10_2 = L10_2(L11_2)
  L11_2 = C8CD510D3A2887FE4
  L11_2 = L11_2.S2A4820A32714F21A
  L12_2 = L10_2
  L11_2(L12_2)
  L11_2 = C8CD510D3A2887FE4
  L11_2 = L11_2.S6DE28230ECBB8BA4
  L12_2 = L10_2
  L11_2(L12_2)
...
function C993132C07A4F918E_prototype:F4453AF39D1F0341E(A1_2)
  ...
  L3_2 = L3_2.S11084CFB16A1F50A
  L3_2()
  while true do
    L3_2 = CCD22EFED4E9E5F89
    L3_2 = L3_2.SF55DE12AD589DB08
    L3_2 = L3_2()
    if L3_2 then
      break
    end
...
L69_1 = _ENV["C993132C07A4F918E"]
L68_1.__class__ = L69_1
L68_1 = _ENV["C993132C07A4F918E"]
L69_1 = "__super__"
L69_1 = _ENV["C993132C07A4F918E"]["prototype"]
L70_1 = {}
L71_1 = "__index"
