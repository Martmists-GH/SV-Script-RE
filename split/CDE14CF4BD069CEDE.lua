...
function L70_1(A0_2)
  ...
  elseif 2 == L1_2 then
    L3_2 = A0_2
    L2_2 = A0_2.F45FC54C0B6C944D4
    L2_2(L3_2)
    A0_2[9] = 3
  elseif 3 == L1_2 then
    L3_2 = A0_2
    L2_2 = A0_2.FC01B84AFBE1030A4
    L2_2 = L2_2(L3_2)
    if not L2_2 then
      return
    end
  ...
  elseif 6 == L1_2 then
    L3_2 = A0_2
    L2_2 = A0_2.F9440C1DF16D53EBB
    L2_2(L3_2)
    A0_2[9] = 7
  elseif 7 == L1_2 then
    L3_2 = A0_2
    L2_2 = A0_2.F029EB9BAB683AB0B
    L2_2 = L2_2(L3_2)
    if not L2_2 then
      return
    end
