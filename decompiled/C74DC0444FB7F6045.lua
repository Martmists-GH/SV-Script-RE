...
function C74DC0444FB7F6045.S58B5E511D87B42D9()
  ...
  if 0 == L0_2 then
    ...
    while L0_2 < L1_2 do
      L0_2 = L0_2 + 1
      L2_2 = L0_2 - 1
      L3_2 = C74DC0444FB7F6045
      L3_2 = L3_2.S7836BBB753DB0986
      L4_2 = L2_2
      L3_2 = L3_2(L4_2)
      L4_2 = C74DC0444FB7F6045
      L4_2 = L4_2.S3ACB08298BC4CCEA
      L5_2 = L2_2
      L4_2 = L4_2(L5_2)
      L5_2 = C74DC0444FB7F6045
      L5_2 = L5_2.S5B4562B15D9879D7
      L6_2 = L2_2
      L5_2 = L5_2(L6_2)
      L6_2 = C74DC0444FB7F6045
      L6_2 = L6_2.S8BC453B97B031C81
      L6_2 = L6_2[L2_2]
      L7_2 = L6_2
      L6_2 = L6_2.f0EF10D0C
      L8_2 = L3_2
    ...
    L2_2 = C74DC0444FB7F6045
    L3_2 = C74DC0444FB7F6045
    L3_2 = L3_2.S441919DE47FAC0A4
    L3_2 = L3_2 + 1
    L2_2.S441919DE47FAC0A4 = L3_2
  end
  L0_2 = true
  L1_2 = 0
  L2_2 = L52_1.__cast
...
function C74DC0444FB7F6045.SEFA15549460C90C5()
  ...
  if 0 == L0_2 then
    ...
    L2_2 = C74DC0444FB7F6045
    L3_2 = C74DC0444FB7F6045
    L3_2 = L3_2.SFA63121A0D177D08
    L3_2 = L3_2 + 1
    L2_2.SFA63121A0D177D08 = L3_2
  end
  L0_2 = true
  L1_2 = 0
  L2_2 = L52_1.__cast
...
function C74DC0444FB7F6045.S7836BBB753DB0986(A0_2)
  ...
  if 0 == L1_2 then
    ...
    L4_2 = L31_1.string
    L5_2 = C74DC0444FB7F6045
    L5_2 = L5_2.SABA1E69DEEFA2A52
    L5_2 = L5_2()
    L4_2 = L4_2(L5_2)
    L3_2 = L3_2 .. L4_2
    L2_2 = L2_2(L3_2)
    L3_2 = L31_1.string
    L4_2 = "/monsname_initial_index.dat"
    L3_2 = L3_2(L4_2)
    L2_2 = L2_2 .. L3_2
    return L2_2
  elseif 1 == L1_2 then
  ...
  elseif 2 == L1_2 then
    ...
    L2_2 = L2_2(L3_2)
    L3_2 = L31_1.string
    L4_2 = "/tokusei_initial_index.dat"
    L3_2 = L3_2(L4_2)
    L2_2 = L2_2 .. L3_2
    return L2_2
  else
...
function C74DC0444FB7F6045.S5B4562B15D9879D7(A0_2)
  ...
  if 0 == L1_2 then
    ...
    L2_2 = L2_2(L3_2)
    L3_2 = L31_1.string
    L4_2 = "/monsname_initial_to_sort.dat"
    L3_2 = L3_2(L4_2)
    L2_2 = L2_2 .. L3_2
    return L2_2
  elseif 1 == L1_2 then
  ...
  elseif 2 == L1_2 then
    ...
    L2_2 = L2_2(L3_2)
    L3_2 = L31_1.string
    L4_2 = "/tokusei_initial_to_sort.dat"
    L3_2 = L3_2(L4_2)
    L2_2 = L2_2 .. L3_2
    return L2_2
  else
...
function C74DC0444FB7F6045.S926E69A25ECD9C07()
  ...
  if 1 == L1_2 then
    L2_2 = C74DC0444FB7F6045
    L0_2 = L2_2.SA86402E1888DFC02
  elseif 8 == L1_2 then
    L2_2 = C74DC0444FB7F6045
    L0_2 = L2_2.SE5E0EBA5DD7F9C6E
  elseif 9 == L1_2 then
    L2_2 = C74DC0444FB7F6045
    L0_2 = L2_2.S835DF1C1957BD10A
  else
    if 10 == L1_2 then
      L2_2 = C74DC0444FB7F6045
      L0_2 = L2_2.S17D5B41EAD9DF889
    else
    end
  end
  return L0_2
