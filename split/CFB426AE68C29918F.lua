...
L68_1[L69_1] = L70_1
L68_1 = _ENV["CFB426AE68C29918F"]["prototype"]
L69_1 = "F68B469351FDC7CA2"

function L70_1(A0_2, A1_2, A2_2, A3_2)
  local L4_2, L5_2, L6_2
  if 0 == A2_2 then
    L5_2 = A0_2
    L4_2 = A0_2.F2ED2385944DF1275
    L6_2 = A3_2
    L4_2(L5_2, L6_2)
  end
end
...
function L70_1(A0_2)
  ...
  if L1_2 < 0 then
    ...
    if 1 == L1_2 then
      L3_2 = A0_2
      L2_2 = A0_2.F0F2455EB3F08B1D1
      L2_2(L3_2)
    elseif 3 == L1_2 then
      L3_2 = A0_2
      L2_2 = A0_2.FC901E1B80A665072
      L2_2(L3_2)
    else
      if 4 == L1_2 then
        L3_2 = A0_2
        L2_2 = A0_2.F90122194950F2E45
        L2_2(L3_2)
      else
      end
    end
