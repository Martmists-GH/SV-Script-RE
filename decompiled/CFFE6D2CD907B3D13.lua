...
function CFFE6D2CD907B3D13.new(A0_2)
  local obj = L2_1(CFFE6D2CD907B3D13.prototype, 6, 19)
...
CFFE6D2CD907B3D13.prototype = L15_1()

function CFFE6D2CD907B3D13.prototype.F5C9B213EA3E5C7AF(self)
  return self[5]
end

function CFFE6D2CD907B3D13.prototype.F7C68FEDB79AB6396(self, A1_2)
  C5A03B25F2E5CB3E2.prototype.F7C68FEDB79AB6396(self, A1_2)
  self[6] = c69ACCC6F.f3F98EEAD(self[1])
end

function CFFE6D2CD907B3D13.prototype.FA23D39922B76B247(self, A1_2)
...
CFFE6D2CD907B3D13.prototype.__class__ = CFFE6D2CD907B3D13
CFFE6D2CD907B3D13.__super__ = C5A03B25F2E5CB3E2
setmetatable(CFFE6D2CD907B3D13.prototype, {__index = C5A03B25F2E5CB3E2})
